...
@section('link')
    {{ route('pegawai.lembagadesa.lembagadesa') }}
@endsection
...
@section('content')
    ...
    @include('pegawai.lembagadesa.modals._lembagapenduduk')
    @include('pegawai.lembagadesa.modals._lembagadesa')
    @include('pegawai.lembagadesa.modals._lembaga')
    ...
    <script>
        $(document).ready(function () {
            $('#order-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('pegawai.lembagadesa.lembagadesa') }}",
                },
                columns: [
                {
                    data: 'DT_RowIndex',
            ...
            format: 'Y-m-d'
             ...
             $('#form_lembagadesa').on('submit', function (event) {
                ...
                if ($('#action').val() == 'edit') {
                    url = "{{ route('pegawai.lembagadesa.lembagadesa-update') }}";
            ...
            $('#form_penduduk').on('submit', function (event) {
                event.preventDefault();
                url = "{{ route('pegawai.lembagadesa.lembagadesa-penduduk') }}";
                text = "Data berhasil ditambah";
            ...
            $(document).on('click', '.edit', function () {
                var id = $(this).attr('id');
                $.ajax({
                    url: '/pegawai/lembagadesa/lembagadesa/'+id,
                    dataType: 'JSON',
                    success: function (data) {
            ...
            //     $.ajax({
            //         url: '/pegawai/lembagadesa/lembagadesa/view-lembaga/'+id,
            //         dataType: 'JSON',
            //         success: function (data) {
            //             console.log(data);
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: '/pegawai/lembagadesa/lembagadesa/hapus/'+user_id,
                    beforeSend: function () {
