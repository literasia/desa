...
@section('describ')
    Ini adalah halaman Member sadar Hukum untuk pegawai
@endsection
...
@section('link')
    {{ route('pegawai.sadarhukum.membersadarhukum') }}
@endsection
...
@section('content')
    ...
    @include('pegawai.sadarhukum.modals._membersadarhukum')
    ...
    <script>
        $(document).ready(function () {
            $('#membersadarhukum-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('pegawai.sadarhukum.membersadarhukum') }}",
                },
                columns: [
                {
                    data: 'DT_RowIndex',
            ...
            format: 'Y-m-d'
             ...
             $('#form_membersadarhukum').on('submit', function (event) {
                ...
                if ($('#action').val() == 'edit') {
                    url = "{{ route('pegawai.sadarhukum.membersadarhukum-update') }}";
            ...
            $(document).on('click', '.edit', function () {
                var id = $(this).attr('id');
                $.ajax({
                    url: '/pegawai/sadarhukum/membersadarhukum/'+id,
                    dataType: 'JSON',
                    success: function (data) {
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: '/pegawai/sadarhukum/membersadarhukum/hapus/'+user_id,
                    beforeSend: function () {
