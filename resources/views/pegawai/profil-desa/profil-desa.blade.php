...
@section('describ')
    Ini adalah halaman Profil Desa untuk Pegawai
@endsection
...
@section('link')
    {{ route('pegawai.profil-desa.profil-desa') }}
@endsection
...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="card-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="village_chief" name="village_chief" placeholder="Kepala Desa" value="{{ $profile->village_chief }}" readonly> 
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="address" class="col-sm-4 col-form-label">Alamat</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="address" name="address" placeholder="Alamat" value="{{ $profile->address }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="phone_number" class="col-sm-4 col-form-label">No. Telepon</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="No. Telepon" value="{{ $profile->phone_number }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="description" class="col-sm-4 col-form-label">Keterangan</label>
                                <div class="col-sm-8">
                                    <textarea type="text" class="form-control" id="description" name="description" placeholder="Keterangan" readonly>{{ $profile->description }}</textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="embed_maps" name="embed_maps" placeholder="Masukkan Embed Maps Desa disini" value="{{ $profile->embed_maps }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-12" id="gallery-container">
            @include('pegawai.profil-desa._profile-gallery', [$galleries])
        </div>
        ...
        $(document).ready(function(){
            if (window.File && window.FileList && window.FileReader && window.Blob) {
                ...
                $('body').on("change", "#gallery2", function(e) {
                    ...
                    $.ajax({
                        url: "{{ route('pegawai.profil-desa.add-gallery') }}",
                        method: 'POST',
                        data: formData,
                        contentType: false,
                        cache: false,
            ...
            $('#profile-form').on('submit', function (event) {
                ...
                $.ajax({
                    url: "{{ route('pegawai.profil-desa.profile-update') }}",
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    cache: false,
            ...
            {
                $.ajax({
                    url: "{{ route('pegawai.profil-desa.refresh-gallery') }}",
                    success: function (data) {
            ...
            $(document).on('click', '.remove-gallery', function(){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('pegawai.profil-desa.delete-gallery') }}",
                            method: 'POST',
                            data: {
