...
@section('title-2', 'Perubahan Kartu Keluarga')
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#form-perubahan-kk').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            $('#modal-perubahan-kk').modal('hide');
                            $('#status').removeClass('is-invalid');
                            $('#form-perubahan-kk')[0].reset();
                            $('#action').val('add');
