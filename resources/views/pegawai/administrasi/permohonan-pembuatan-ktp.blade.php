...
@include('pegawai.administrasi.modals._permohonan-ktp')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#form-ktp').on('submit', function (event) {
                ...
                var url = '';
                if ($('#action').val() == 'edit') {
                    url = "{{ route('pegawai.administrasi.permohonan-pembuatan-ktp.update') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                var id = $(this).attr('id');
                $.ajax({
                    url: '/pegawai/administrasi/permohonan-pembuatan-ktp/'+id,
                    dataType: 'JSON',
                    success: function (data) {
                        $('#action').val('edit');
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: '/pegawai/administrasi/permohonan-pembuatan-ktp/hapus/'+user_id,
                    beforeSend: function () {
