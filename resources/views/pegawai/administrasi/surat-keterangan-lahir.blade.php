...
@include('pegawai.administrasi.modals._surat-keterangan-lahir')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#form-keterangan-lahir').on('submit', function (event) {
                ...
                var url = '';
                if ($('#action').val() == 'edit') {
                    url = "{{ route('pegawai.administrasi.surat-keterangan-lahir.update') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                var id = $(this).attr('id');
                $.ajax({
                    url: '/pegawai/administrasi/surat-keterangan-lahir/'+id,
                    dataType: 'JSON',
                    success: function (data) {
                        $('#action').val('edit');
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: '/pegawai/administrasi/surat-keterangan-lahir/hapus/'+user_id,
                    beforeSend: function () {
