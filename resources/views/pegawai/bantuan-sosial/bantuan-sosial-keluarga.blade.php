...
@section('describ')
    Ini adalah halaman bantuan sosial per keluarga untuk pegawai
@endsection
...
<div class="row">
    ...
    {{-- Modal --}}
    @include('pegawai.bantuan-sosial.modals._status_bansos_keluarga')
    @include('pegawai.bantuan-sosial.modals._bantuan_sosial_keluarga')
@endsection
...
<script>
        $(document).ready(function () {
            ...
            $('#order-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('pegawai.bantuan-sosial.bantuan-sosial-keluarga') }}",
                },
                columns: [
                {
                    data: 'DT_RowIndex',
            ...
            $(document).on('click', '.edit-status', function () {
                var id = $(this).attr('id');
                $.ajax({
                    url: '/pegawai/bantuan-sosial/bantuan-sosial-keluarga/'+id,
                    dataType: 'JSON',
            ...
            $('#form-status-bansos-keluarga').on('submit', function (event) {
                ...
                $.ajax({
                    url: "{{ route('pegawai.bantuan-sosial.bantuan-sosial-keluarga.update-status') }}",
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    cache: false,
            ...
            $('#form-bantuan-sosial-keluarga').on('submit', function (event) {
                ...
                var url = '';
                if ($('#action').val() == 'add') {
                    url = "{{ route('pegawai.bantuan-sosial.bantuan-sosial-keluarga.store') }}";
                }

                if ($('#action').val() == 'edit') {
                    url = "{{ route('pegawai.bantuan-sosial.bantuan-sosial-keluarga.update') }}";
                }
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: '/pegawai/bantuan-sosial/bantuan-sosial-keluarga/hapus/'+user_id,
                    beforeSend: function () {
