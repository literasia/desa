...
@section('describ')
    Ini adalah halaman jenis bantuan sosial untuk admin
@endsection
...
@section('link')
    {{ route('admin.bantuan-sosial.jenis-bantuan-sosial') }}
@endsection
...
<div class="row">
    ...
    {{-- Modal --}}
    @include('admin.bantuan-sosial.modals._jenis_bantuan_sosial')
@endsection
...
<script>
        $(document).ready(function () {
            ...
            $('#order-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.bantuan-sosial.jenis-bantuan-sosial') }}",
                },
                columns: [
                {
                    data: 'DT_RowIndex',
            ...
            $('#form-jenis-bantuan-sosial').on('submit', function (event) {
                ...
                var url = '';
                if ($('#action').val() == 'add') {
                    url = "{{ route('admin.bantuan-sosial.jenis-bantuan-sosial.store') }}";
                }

                if ($('#action').val() == 'edit') {
                    url = "{{ route('admin.bantuan-sosial.jenis-bantuan-sosial.update') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                var id = $(this).attr('id');
                $.ajax({
                    url: '/admin/bantuan-sosial/jenis-bantuan-sosial/'+id,
                    dataType: 'JSON',
                    success: function (data) {
                        console.log(data);
                        $('#action').val('edit');
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: '/admin/bantuan-sosial/jenis-bantuan-sosial/hapus/'+user_id,
                    beforeSend: function () {
