...
@section('describ')
    Ini adalah halaman Sadar Hukum untuk admin
@endsection
...
@section('link')
    {{ route('admin.sadarhukum.sadarhukum') }}
@endsection
...
<div class="row">
    ...
    {{-- Modal --}}
    @include('admin.sadarhukum.modals._sadarhukum')
@endsection
...
<script>
        $(document).ready(function () {
            ...
            $('#order-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.sadarhukum.sadarhukum') }}",
                },
                columns: [
                {
                    data: 'DT_RowIndex',
            ...
            $('#form_sadarhukum').on('submit', function (event) {
                ...
                if ($('#action').val() == 'edit') {
                    url = "{{ route('admin.sadarhukum.sadarhukum.update') }}";
                }
            ...
            $(document).on('click', '.edit', function () {
                var id = $(this).attr('id');
                $.ajax({
                    url: '/admin/sadarhukum/sadarhukum/'+id,
                    dataType: 'JSON',
                    success: function (data) {
                        $('#action').val('edit');
            ...
            $('#ok_button').click(function () {
                $.ajax({
                    url: '/admin/sadarhukum/sadarhukum/hapus/'+user_id,
                    beforeSend: function () {
