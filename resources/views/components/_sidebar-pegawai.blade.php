    ...
    <div class="nav-list">
        <div class="pcoded-inner-navbar main-menu">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                @if ($employee->access->greeting)
                <li class="{{ request()->is('pegawai/sambutan-kepala-desa') ? 'active' : '' }}">
                    <a href="{{ route('pegawai.sambutan-kepala-desa') }}" class="waves-effect waves-dark">
                        <span class="pcoded-micon">
               ...
               <li class="@if (request()->is('pegawai/administrasi/permohonan-pembuatan-ktp') || request()->is('pegawai/administrasi/surat-keterangan-lahir') || request()->is('pegawai/administrasi/perubahan-kk') || request()->is('pegawai/administrasi/surat-kematian') || request()->is('pegawai/administrasi/izin-usaha') || request()->is('pegawai/administrasi/keterangan-tidak-mampu') || request()->is('pegawai/administrasi/permohonan-skck') || request()->is('pegawai/administrasi/keterangan-pindah') || request()->is('pegawai/administrasi/keterangan-domisili') || request()->is('pegawai/administrasi/keterangan-ahli-waris') || request()->is('pegawai/administrasi/keterangan-tanah')) pcoded-hasmenu active pcoded-trigger @else pcoded-hasmenu @endif">
                ...
                <li class="@if (request()->is('pegawai/bantuan-sosial/bantuan-sosial-individu') || request()->is('pegawai/bantuan-sosial/bantuan-sosial-keluarga') || request()->is('pegawai/bantuan-sosial/jenis-bantuan-sosial')) pcoded-hasmenu active pcoded-trigger @else pcoded-hasmenu @endif">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{ request()->is('pegawai/bantuan-sosial/jenis-bantuan-sosial') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.bantuan-sosial.jenis-bantuan-sosial') }}" class="waves-effect waves-dark">
                                <span class="pcoded-mtext">Jenis Bantuan</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('pegawai/bantuan-sosial/bantuan-sosial-keluarga') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.bantuan-sosial.bantuan-sosial-keluarga') }}" class="waves-effect waves-dark">
                                <span class="pcoded-mtext">Keluarga</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('pegawai/bantuan-sosial/bantuan-sosial-individu') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.bantuan-sosial.bantuan-sosial-individu') }}" class="waves-effect waves-dark">
               ...
               <li class="@if (request()->is('pegawai/peristiwa/kelahiran') || request()->is('pegawai/peristiwa/kematian') || request()->is('pegawai/peristiwa/pindah')) pcoded-hasmenu active pcoded-trigger @else pcoded-hasmenu @endif">
                ...
                @if ($employee->access->community)
                <li class="@if (request()->is('pegawai/lembagadesa/lembagadesa') ||  request()->is('pegawai/lembagadesa/jenislembaga')) pcoded-hasmenu active pcoded-trigger @else pcoded-hasmenu @endif">
                    <a href="javascript:void(0);" class="waves-effect waves-dark">
                        <span class="pcoded-micon">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{ request()->is('pegawai/lembagadesa/lembagadesa') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.lembagadesa.lembagadesa') }}" class="waves-effect waves-dark">
                                <span class="pcoded-mtext">Lembaga</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('pegawai/lembagadesa/jenislembaga') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.lembagadesa.jenislembaga') }}" class="waves-effect waves-dark">
                ...
                @if ($employee->access->awareness)
                <li class="@if (request()->is('pegawai/sadarhukum/sadarhukum') ||  request()->is('pegawai/sadarhukum/membersadarhukum')) pcoded-hasmenu active pcoded-trigger @else pcoded-hasmenu @endif">
                    <a href="javascript:void(0);" class="waves-effect waves-dark">
                        <span class="pcoded-micon">
                            <i class="fa fa-building"></i>
                        </span>
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{ request()->is('pegawai/sadarhukum/sadarhukum') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.sadarhukum.sadarhukum') }}" class="waves-effect waves-dark">
                                <span class="pcoded-mtext">Sadar Hukum</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('pegawai/sadarhukum/membersadarhukum') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.sadarhukum.membersadarhukum') }}" class="waves-effect waves-dark">
                ...
                @if ($employee->access->development)
                <li class="@if (request()->is('pegawai/pembangunan/pembangunan') ||  request()->is('pegawai/pembangunan/jenispembangunan')) pcoded-hasmenu active pcoded-trigger @else pcoded-hasmenu @endif">
                    <a href="javascript:void(0);" class="waves-effect waves-dark">
                        <span class="pcoded-micon">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{ request()->is('pegawai/pembangunan/pembangunan') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.pembangunan.pembangunan') }}" class="waves-effect waves-dark">
                                <span class="pcoded-mtext">Program Desa</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('pegawai/pembangunan/jenispembangunan') ? 'active' : '' }}">
                            <a href="{{ route('pegawai.pembangunan.jenispembangunan') }}" class="waves-effect waves-dark">
