...
<script type="text/javascript">
    ...
    function add_event(form_data) {
        ...
        //Jika kosong
        if (event_title == "" || start_date == "" || end_date == "" || start_clock == "" || end_clock == "") {
            swal.fire({
        ...
        //Jika tidak
            ...
            $.ajax({
                ...
                url: "{{route('superadmin.superadmin.kalender.tambah-event')}}",
                method: "POST",
                dataType: "JSON",
                data: form_data,
                async: false,
    ...
    function update_event(form_data) {
        ...
        $.ajax({
            ...
            url: "/superadmin/kalender/update/" + $("#id_event").val(),
            method: "POST",
            dataType: "JSON",
            data: form_data,
            async: false,
    ...
    function del_event(id_event) {
        ...
        $('#ok_button').click(function() {
            $.ajax({
                ...
                url: '/superadmin/kalender/hapus/' + id_event,
                beforeSend: function() {
