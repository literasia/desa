...
class CitizenAPIController extends Controller
{
    ...
    public function addCitizen(Request $request, $village_id)
    {
        ...
        $message = [
            ...
            'name'  => 'This column cannot be empty',
            'no_kk' => 'This column cannot be empty',
            'nik' => 'This column cannot be empty',
            'email' => 'This column cannot be empty',
            'phone' => 'This column cannot be empty',
            'citizenship' => 'This column cannot be empty',
            'place_of_birth' => 'This column cannot be empty',
            'date_of_birth' => 'This column cannot be empty',
            'sex' => 'This column cannot be empty',
            'religion' => 'This column cannot be empty',
            'education' => 'This column cannot be empty',
            'marital_status' => 'This column cannot be empty',
            'family_status' => 'This column cannot be empty',
            'work_type' => 'This column cannot be empty',
            'province_id' => 'This column cannot be empty',
            'regency_id' => 'This column cannot be empty',
            'district_id' => 'This column cannot be empty',
            'address' => 'required',
        ];
