...
class PengumumanDesaController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = AdminMessage::orderBy('created_at',"desc")->get();
        ...
        // $data = AdminMessage::orderBy('created_at',"desc")->get();
        // dd($data);
        return view('superadmin.pengumuman.pengumuman');
    }
    ...
    public function update(Request $req)
    {
        ...
        $update = AdminMessage::where('id', $req->hidden_id)->update([
            'title' => $req->title,
            'notification' => $notifikasi,
            'dashboard' => $dashboard,
