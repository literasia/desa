...
{   
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.potensidesa.vendor', ['category' => $category]);
    }
    ...
    *
    ...
    public function store(Request $req)
    {
        ...
        $data['image'] = null;
        if ($req->file('image')) {
            $data['image'] = $req->file('image')->store('vendor', 'public');
        }
    ...
    public function update(Request $req) {
        ...
        $vendor = News::findOrFail($data['hidden_id']);
        $data['image'] = null;
        if ($req->file('image')) {
            $data['image'] = $req->file('image')->store('vendor', 'public');
        }
        ...
        if ($req->file('image') && $vendor->image && Storage::disk('public')->exists($vendor->image)) {
