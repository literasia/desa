...
namespace App\Http\Controllers\Pegawai\Potensi;
...
class KategoriUsahaController extends Controller
{
    public function index(Request $request) {
        if ($request->ajax()) {
            $data = CategoryBusiness::where('village_id', auth()->user()->village->id)->get();
        ...
        return view('pegawai.potensi.kategori-usaha', ["employee"=>$employee]);
    }
