...
class KeteranganAhliWarisController extends Controller
{
    ...
    {
        $data = Heir::where('village_id', auth()->user()->village->id)->get();
        ...
        return view('pegawai.administrasi.keterangan-ahli-waris', ["employee"=>$employee]);
    }
    ...
    public function update(Request $req) {
        ...
        Heir::whereId($data['hidden_id'])->update([
